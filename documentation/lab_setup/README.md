...
4. [Sandbox Network and INetSim](./sandbox_network_and_inetsim.md): details how the isolated network was configured as well as the configuration required for INetSim and some troubleshooting of unexpected issues.
